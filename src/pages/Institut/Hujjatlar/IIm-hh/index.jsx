...
import APIHujjatIIm_hh from "../../../../services/hujjatIIm_hh";
  ...
  const [data, setData] = useState([]);
    ...
    const onEditN = (item, boolean) => {
        if (boolean) {
            ...
            APIHujjatIIm_hh.patch(item.id, data)
                .then(() => {
                    getData();
                })
                .catch((err) => console.log(err));
