...
import APIJamoat from "../../services/faoliyatJamoat";
import { RiDeleteBin5Line } from "react-icons/ri";
import "./style.css";

const JamoatchilikFaoliyat = () => {
  ...
  return (
    <div className="App p-4">
      <h1 className="text-2xl font-bold mb-5 p-3 text-center">
        Jamoatchilik kengashi faoliyati
      </h1>
...
export default JamoatchilikFaoliyat;
