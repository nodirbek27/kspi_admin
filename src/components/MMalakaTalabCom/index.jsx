...
import APIMMalakaTalab from "../../services/mMalakaTalab";
import { Formik, useFormik } from "formik";
import MyTextInput from "../MyTextInput";

const MMalakaTalabCom = () => {
  ...
  const fechtData = async () => {
    try {
      const response = await APIMMalakaTalab.get();
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, onSubmitProps) => {
      ...
      try {
        // POST
        if (!edit) {
          await APIMMalakaTalab.post(data);
        }
        // PATCH
        else {
          await APIMMalakaTalab.patch(id, data);
          console.log(data);
          setEdit(false);
          setId(null);
        }
...
export default MMalakaTalabCom;