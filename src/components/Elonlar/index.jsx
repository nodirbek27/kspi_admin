...
const News = () => {
    ...
    const displayedNews =
        news && news.slice(pagesVisited, pagesVisited + itemsPerPage);
    ...
    return (
        <div className="mx-2 lg:mx-5 xl:mx-10">
            <h1 className="text-3xl font-bold text-center mb-5 pt-3">
                E'lonlar
            </h1>
            ...
            <div className="flex flex-col">
                ...
                <ReactPaginate
                    ...
                    containerClassName={
                        "pagination flex justify-center p-0 my-5 mx-0"
                    }
                    previousLinkClassName={
                        "pagination__link hover:bg-[#eee] font-bold"
                    }
                    nextLinkClassName={
                        "pagination__link hover:bg-[#eee] font-bold"
                    }
                    disabledClassName={
                        "pagination__link--disabled color-[#888]"
                    }
                    activeClassName={
