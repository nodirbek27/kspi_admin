...
const Rektorat = () => {
    ...
    const faceData = [
        {
            id: 1,
            name_uz: "Rector asdczxczcxzcx bdfgbdgbfgbnfgb fd sdfsf fasdfaSD ASDASD S",
            name_ru: "вдлы овадлыв фывдлжфлыдлвфж лывды",
            name_en: "kds laksvb lda xcxc en",
        },
        {
            id: 2,
            name_uz: "Yoshlar masalalari va ma'naviy-ma'rifiy ishlar bo'yicha prorektor",
            ...
            <div className="w-full h-full">
                ...
                <div>
                    ...
                    <ol className="list-decimal flex flex-col gap-2">
                        {faceData.map(({ id, name_uz, name_ru, name_en }) => (
                            <li className="border bg-gray-50 p-2" key={id}>
                                <div className="flex justify-between items-center">
                                    <p className=" inline-block">{name_uz}</p>
                ...
                {/* <ol className="list-decimal">
                    {faceData.map(({id, name_uz}) => (
                        <li key={id}>
                            <p>{name_uz}</p>
                            <div className="flex gap-4">
                                <button className="flex items-center gap-2 bg-red-600 rounded-md py-1 px-4 text-white font-medium">
                                    Tahrirlash <MdEdit />
                                </button>
                                <button className="flex items-center gap-2 bg-red-600 rounded-md py-1 px-4 text-white font-medium">
                                    Delete <MdDelete />
