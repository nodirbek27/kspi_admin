            ...
            <ol className="list-decimal flex flex-col gap-2 ps-4">
              {dataLavozim?.length !== 0 && dataLavozim ? (
                dataLavozim?.map((item) => (
                  <li className="border bg-gray-50 shadow-md p-2" key={item.id}>
                    <div className="flex justify-between gap-20 items-center">
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={() => onEdit(item, isEdit?.id === item.id)}
                ...
                <div className="text-red-600">Ma'lumot mavjud emas!</div>
              )}
            </ol>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              <div className="w-full flex gap-2">
                <label className="w-[33.33%]" htmlFor="lavozim_uz">
                  Lavozim uz
                  <textarea
                    type="text"
                    id="lavozim_uz"
                ...
                <label className="w-[33.33%]" htmlFor="lavozim_ru">
                  Lavozim ru
                  <textarea
                    type="text"
                    id="lavozim_ru"
                ...
                <label className="w-[33.33%]" htmlFor="lavozim_en">
                  Lavozim en
                  <textarea
                    type="text"
                    id="lavozim_en"
              ...
              {/* Unvoni */}
              <div className="w-full flex gap-2">
                <label className="w-[33.33%]" htmlFor="unvon_uz">
                  Unvon uz
                  <textarea
                    type="text"
                    id="unvon_uz"
                ...
                <label className="w-[33.33%]" htmlFor="unvon_ru">
                  Unvon ru
                  <textarea
                    type="text"
                    id="unvon_ru"
                ...
                <label className="w-[33.33%]" htmlFor="unvon_en">
                  Unvon en
                  <textarea
                    type="text"
                    id="unvon_en"
              ...
              {/* Qabul soati */}
              <div className="w-full flex gap-2">
                <label className="w-[33.33%]" htmlFor="qabul_soati_uz">
                  Qabul soati uz
                  <textarea
                    type="text"
                    id="qabul_soati_uz"
                ...
                <label className="w-[33.33%]" htmlFor="qabul_soati_ru">
                  Qabul soati ru
                  <textarea
                    type="text"
                    id="qabul_soati_ru"
                ...
                <label className="w-[33.33%]" htmlFor="qabul_soati_en">
                  Qabul soati en
                  <textarea
                    type="text"
                    id="qabul_soati_en"
              ...
              {/* biografiya_uz */}
              <div className="w-full flex gap-2">
                <label className="w-[33.33%]" htmlFor="biografiya_uz">
                  Biografiya uz
                  <textarea
                    type="text"
                    id="biografiya_uz"
                ...
                <label className="w-[33.33%]" htmlFor="biografiya_ru">
                  Biografiya ru
                  <textarea
                    type="text"
                    id="biografiya_ru"
                ...
                <label className="w-[33.33%]" htmlFor="biografiya_en">
                  Biografiya en
                  <textarea
                    type="text"
                    id="biografiya_en"
              ...
              <div className="w-full flex gap-2">
                {/* telefon_nomer */}
                <label className="w-[33.33%]" htmlFor="telefon_nomer">
                  Telefon No'mer
                  <input
                    type="number"
                    id="telefon_nomer"
                ...
                {/* tg_username */}
                <label className="w-[33.33%]" htmlFor="tg_username">
                  Telegram link
                  <input
                    type="text"
                    id="tg_username"
                  ...
                  data?.map((item) => (
                    ...
                    >
                      <div className="flex flex-col items-start gap-4">
                        <div>
                          <p>
                            <b>Lavozim:</b> {item.lavozim_uz}
                          </p>
                          <p>
                            <b>FISH:</b> {item.fish_uz}
                          </p>
                          <p>
                            <b>Unvon:</b> {item.unvon_uz}
                          </p>
                          <p>
                            <b>Qabul soatlari:</b> {item.qabul_soati_uz}
                          </p>
                          <p>
                            <b>Telefon no'meri:</b> {item.telefon_nomer}
                          </p>
                          <p>
                            <b>Telegram linki:</b> {item.tg_username}
                          </p>
                          <p>
                            <b>Biografyasi:</b> {item.biografiya_uz}
                          </p>
                        </div>
