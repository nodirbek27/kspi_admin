...
import APIHujjatORpf from "../../../../services/hujjatORpf";
...
const ORpf = () => {
    ...
    const onEditN = (item, boolean) => {
        if (boolean) {
            ...
            APIHujjatORpf.patch(item.id, data)
                .then(() => {
                    getData();
                })
                .catch((err) => console.log(err));
        ...
        <div className="relative">
            ...
            <div className="w-full p-[10px] -z-10">
                <h1 className="text-center text-[1.8rem] font-medium mt-4">
                    O'zbekistor Respublikasi prizidentining farmonlari
                </h1>
                <div className="my-10">
