...
import APIKorHaqHabBerish from "../../services/korHaqHabBerish";

const KorHaqHabBerish = () => {
    ...
    const onEditN = (item, boolean) => {
        if (boolean) {
            ...
            APIKorHaqHabBerish.patch(item.id, data)
                .then(() => {
                    getData();
                })
                .catch((err) => console.log(err));
        ...
        <div className="relative">
            ...
            <div className="w-full p-[10px] -z-10">
                <h1 className="text-center text-[1.8rem] font-medium mt-4">
                    Korrupsya haqida habar berish
                </h1>
                <div className="my-10">
                    <h1 className="text-[1.4rem] font-medium mb-2">
                        Korrupsya haqida habar berish nomi
                    </h1>
...
export default KorHaqHabBerish;
