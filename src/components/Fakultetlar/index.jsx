...
const Rektorat = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            if (
                ...
                setLoad(true);
                APITuzilmaFakultet.post(values)
                    .then(() => {
                        getDataLavozim();
                    })
    ...
    const onEdit = ({ id, name_uz, name_ru, name_en }, boolean) => {
        if (boolean) {
            ...
            const { id, ...res } = isEdit;
            const data = res;
            APITuzilmaFakultet.patch(id, data)
                .then(() => {
                    getDataLavozim();
                })
                .catch((err) => console.log(err));
    ...
    const onEditN = (item, boolean) => {
        if (boolean) {
            ...
            APITuzilmaFakultet.patchH(item.id, data)
                .then(() => {
                    getDataNomzod();
                })
                .catch((err) => console.log(err));
